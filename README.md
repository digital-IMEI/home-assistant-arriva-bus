...
Follow an Arriva bus from departure to your chosen stop, directly in Home Assistant.
Choose a line, destination and stop from searchable lists and the integration handles
the technical identifiers, stop codes and realtime data behind the scenes.
...
<p align="center">
  <img src="docs/images/live-activity-waiting.jpeg" alt="Arriva Bus Live Activity waiting to depart" width="340">
</p>

The waiting state stays compact and deliberately omits the progress bar. More status
...
| **Next stop passage** | Sensor · timestamp | Scheduled arrival/passage time at the stop selected during setup. |
